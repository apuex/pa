...
public class MQMessageConverter {
    ...
    public MQMessage fromBytesMessage(BytesMessage bm) throws JMSException {
        ...
        mqMessage.setPaBase(pPA);
        mqMessage.setPathName(bm.getStringProperty("PathName"));
        mqMessage.setDestName(bm.getStringProperty("DestName"));
